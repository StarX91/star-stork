  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center relative">
        <select className="bg-neutral-800 text-white py-2 px-4 rounded-lg focus:outline-none">
        ...
        <div className="relative">
          <button
            className="bg-neutral-900 text-white py-2 px-4 rounded-lg hover:bg-neutral-700"
          ...
          {/* Dropdown */}
          {isDropdownOpen && (
            <div className="absolute right-0 mt-2 w-60 bg-neutral-900 rounded-lg shadow-lg py-2 z-20">
              {/* Additional Dropdown Options */}
              <div className="px-4 py-2 flex items-center hover:bg-neutral-800 cursor-pointer">
              ...
              <div className="px-4 py-2 flex items-center hover:bg-neutral-800 cursor-pointer">
                ...
                <div>
                  ...
                  <p className="text-neutral-500 text-sm">
                    Analyze image using detector
                  </p>
                </div>
              </div>
              <div
                className="px-4 py-2 flex items-center hover:bg-neutral-800 cursor-pointer"
      ...
      <div className="bg-neutral-900 p-4 rounded-lg relative">
        <button className="absolute right-2 top-2 text-neutral-300 text-sm">
          View All
        </button>
        <div className="items-center ">
          ...
          <div className="flex justify-between w-1/5">
            ...
            <button className="ml-auto text-neutral-400">...</button>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        >
          ...
          <button className="absolute top-2 right-2 text-neutral-400 text-sm">
            View All
          </button>
        </div>
        <div
